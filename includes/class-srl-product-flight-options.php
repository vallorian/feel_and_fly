...
class SRL_Product_Flight_Options {
    ...
    private function initHooks() {
        add_action('woocommerce_single_product_summary', array($this, 'wyswietlFormularzWyboruLotu'), 25);
    }

    public function wyswietlFormularzWyboruLotu() {
        global $product;

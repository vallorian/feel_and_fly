...
function srl_generuj_sekcje_voucherow($show_title = true) {
    ...
    <div class="srl-voucher-options" style="display: grid; grid-template-columns: repeat(auto-fit, minmax(250px, 1fr)); gap: 20px; margin-top: 20px;">
        ...
        <div class="srl-voucher-card" id="srl-voucher-feelfly">
            ...
            <div class="srl-voucher-content" style="padding: 20px; border: 2px solid #0073aa; border-top: none; border-radius: 0 0 8px 8px; background: white;">
                <div id="srl-voucher-form" style="display: none;">
                    <div class="srl-form-group">
                        <label for="srl-voucher-code">Kod vouchera:</label>
                        <input type="text" id="srl-voucher-code" placeholder="Wpisz 10-znakowy kod" maxlength="10" style="text-transform: uppercase;">
                    </div>
        ...
        <!-- Wykorzystaj Voucher partnera (nieaktywny) -->
        <div class="srl-voucher-card" style="opacity: 0.6;">
            ...
            <div class="srl-voucher-content" style="padding: 20px; border: 2px solid #6c757d; border-top: none; border-radius: 0 0 8px 8px; background: #f8f9fa;">
...
function srl_generuj_js_voucherow() {
    ...
    jQuery(document).ready(function($) {
        ...
        $(document).on('click', '#srl-voucher-submit', function() {
            ...
            if (kod.length !== 10) {
                alert('Kod vouchera musi mieć 10 znaków.');
                return;
            }
...
function srl_shortcode_kalendarz() {
    ...
    <div id="srl-rezerwacja-container">
        ...
        <div id="srl-krok-1" class="srl-krok srl-krok-active">
            <h2>👋 Witaj, <?php echo esc_html(wp_get_current_user()->display_name); ?>!</h2>
            
            <!-- Aktualne rezerwacje -->
            <div id="srl-aktualne-rezerwacje">
                <h3>📅 Twoje aktualne rezerwacje</h3>
...
<!-- Dostępne loty -->
<div id="srl-dostepne-loty">
    <h3>🎫 Loty do zarezerwowania</h3>
    <div id="srl-wybor-lotu">
        <div class="srl-loader">Ładowanie...</div>
    </div>
    
    <!-- Sekcja voucherów i zakupów -->
    <div id="srl-voucher-section" style="margin-top: 30px;">
        <?php echo srl_generuj_sekcje_voucherow(false); // false = nie pokazuj tytułu ?>
    </div>
</div>
        ...
        <div id="srl-krok-3" class="srl-krok">
            ...
            <div class="srl-form-actions">
                <button id="srl-powrot-krok-2" class="srl-btn srl-btn-secondary">← Zmień dzień</button>
                <button id="srl-dalej-krok-4" class="srl-btn srl-btn-primary" style="display:none;">
        ...
        <div id="srl-krok-4" class="srl-krok">
            ...
            <div class="srl-form-actions">
                <button id="srl-powrot-krok-3" class="srl-btn srl-btn-secondary">← Zmień godzinę</button>

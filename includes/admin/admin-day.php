<?php function srl_wyswietl_dzien() {
    ...
    $dni_tyg = array(1 => 'Poniedziałek', 2 => 'Wtorek', 3 => 'Środa', 4 => 'Czwartek', 5 => 'Piątek', 6 => 'Sobota', 7 => 'Niedziela');
    ...
    echo '</div>';
    echo '</div>';
    echo '</div>'; ?><script src="<?php echo SRL_PLUGIN_URL; ?>assets/js/admin-day.js"type="text/javascript"></script><?php
}

...
function srl_ajax_przypisz_klienta_do_slotu() {
    ...
    try {
        ...
        $wpis_historii = array('data' => srl_get_current_datetime(), 'opis' => "Lot przypisany do terminu przez administratora: {$termin_opis} dla klienta: {$klient_info}", 'typ' => 'przypisanie_admin', 'executor' => 'Admin', 'szczegoly' => array('termin_id' => $termin_id, 'data_lotu' => $termin['data'], 'godzina_start' => $termin['godzina_start'], 'godzina_koniec' => $termin['godzina_koniec'], 'pilot_id' => $termin['pilot_id'], 'user_id' => $lot['user_id'], 'user_info' => $klient_info, 'stary_status' => 'wolny', 'nowy_status' => 'zarezerwowany'));
